/*
 *  $Source: v:/cvsroot/open/projects/WebARTS/ca/bc/webarts/widgets/dnd/FileDrop.java,v $
 *  $Name:  $
 *  $Revision: 1.1 $
 *  $Date: 2001/11/01 05:54:28 $
 *  $Locker:  $
 */
/*
...
public class FileDrop
{
                    ...
                    {   // Get whatever was dropped
                        ...
                        if( isDroppedFileList( out, evt ) )
                        {
                            ...
                            java.util.List fileList = (java.util.List)
                                ...
                                //tr.getTransferData(java.awt.datatransfer.DataFlavor.stringFlavor );
                            java.util.Iterator iterator = fileList.iterator();

                            /*
                            String [] filenamesArray = new String [ fileList.size() ];
                            fileList.toArray( filenamesArray );
                            log( out, "FileDrop: dropped filenames:" );
                            for (int iii = 0; iii < filenamesArray.length; iii++)
                            {
                              log( out, "         " + filenamesArray[iii]);
                            }
                            */
    ...
    private boolean isDroppedFileList( final java.io.PrintStream out, final java.awt.dnd.DropTargetDropEvent evt )
    {   
      boolean ok = false;

        // Get data flavors being dragged
        java.awt.datatransfer.DataFlavor[] flavors = evt.getCurrentDataFlavors();
        //log( out, "FileDrop: Number of flavors="+flavors.length );
        ...
        {   // Is the flavor a file list?
            ...
            {
                ok = true;
                //log( out, "FileDrop: Acceptable data flavors. "+ flavors[i].getMimeType() );
            }
            //log( out, "FileDrop: Found data flavors. "+ flavors[i].getMimeType() );
            i++;
    ...
    private boolean isDraggedFileList( final java.io.PrintStream out, final java.awt.dnd.DropTargetDragEvent evt )
    {   
      boolean ok = false;
